...
public class MRlinGestureScriptNew : MonoBehaviour 
{
	...
	void setGestureConfig()
	{
		...
		player.GetComponent<PlayerInputMRlin>().setTextureO(textSpellO);
		player.GetComponent<PlayerInputMRlin>().setTexture7(textSpell7);
		player.GetComponent<PlayerInputMRlin>().setTextureZ(textSpellZ);
		player.GetComponent<PlayerInputMRlin>().setTextureM(textSpellM);
	...
	{
		player.GetComponent<MageControllerNew>().gestureCode = 1;
	...
	{
		player.GetComponent<MageControllerNew>().gestureCode = 2;
	...
	{
		player.GetComponent<MageControllerNew>().gestureCode = 3;
	...
	{
		player.GetComponent<MageControllerNew>().gestureCode = 4;
		Debug.Log("Gesture   correct   M");
		//this.gameObject.GetComponent<Renderer>().material.color = Color.black;
	}
	void onGestureWrong()
	{
		player.GetComponent<MageControllerNew>().gestureCode = 0;
